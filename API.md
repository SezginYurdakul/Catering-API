...
```
http://localhost/web_backend_test_catering_api
```
...
1. **Create Location**
   ...
   - **Example Request**:
     ```bash
     curl --location 'http://localhost/web_backend_test_catering_api/locations' \
...
2. **Update Location**
   ...
   - **Example Request**:
     ```bash
     curl --location --request PUT 'http://localhost/web_backend_test_catering_api/locations/1' \
     --header 'Content-Type: application/json' \
     --data '{
         "city": "Rotterdam",
         "address": "Coolsingel 10",
...
3. **Retrieve Location**
   ...
   - **Example Request**:
     ```bash
     curl --location 'http://localhost/web_backend_test_catering_api/locations/1' \
     --header 'Content-Type: application/json'
     ```
   - **Response**:
     ```json
...
4. **List Locations**
   ...
   - **Example Request**:
     ```bash
     curl --location 'http://localhost/web_backend_test_catering_api/locations?page=1&per_page=5' \
     --header 'Content-Type: application/json'
     ```
   - **Response**:
     ```json
...
```bash
curl --location 'http://localhost/web_backend_test_catering_api/facilities' \
--header 'Content-Type: application/json' \
